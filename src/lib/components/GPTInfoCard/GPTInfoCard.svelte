...
{#if gptInfo}
	...
	>
		...
		<div class="col-start-6 row-start-3 align-baseline flex justify-end items-end">
			<a href="{GPT_PATH}/{gptInfo.slug}" class="btn btn-primary"
				>Use <i class="ph-bold ph-arrow-square-out" /></a
			>
		</div>
	</svelte:element>
{/if}
